...
const EVENTS_DATA = [
  {
    ...
    title: "Xceed Virtual Networking Meet November",
  },
  {
    image: Event1,
    date: new Date("2025-11-25"),
    title: "Xceed Diwali Meet November in Jaipur",
  },
  {
    image: Event2,
    date: new Date("2025-11-18"),
  ...
  return (
    <section className="events-section">
      ...
      <p className="events-description">
        At Xceed Network, events are more than just gatherings — they are
        opportunities to connect, learn, and grow. From intimate mentorship
        sessions to large-scale networking summits, our events are designed to
        create meaningful interactions and lasting business impact.
      </p>
